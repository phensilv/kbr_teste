            ...
            <div class="bg-custom rounded overflow-hidden">
                <table class="table mb-0 table-custom table-dark align-middle">
                    ...
                    <tbody>
                        ...
                        while($animal_data = mysqli_fetch_assoc($result)){
                            echo "<tr>";
                            echo "<td>" . $animal_data['id_animais']."</td>";
                            echo "<td>" . $animal_data['nome_animal']."</td>";
                            echo "<td>" . $animal_data['sexo']."</td>";
                            echo "<td>" . $animal_data['raca']."</td>";
                            echo "<td>" . $animal_data['local']."</td>";
                            echo "<td>
                                    <div class='d-flex justify-content-center'>
                                        ...
                                        <a href='editar.php?id=$animal_data[id_animais]' class='btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2' title='Editar'>
                                        ...
                                        <a href='excluirAnimal.php?id=$animal_data[id_animais]' class='btn btn-danger d-flex justify-content-center align-items-center rounded-circle p-2 mx-2' title='Deletar'>
                ...
                <div class="modal-body d-flex flex-wrap row-gap-4">
                    <?php 
                        ...
                        while($user_data = mysqli_fetch_assoc($result)){
                            $nome_animal = $animal_data['nome_animal'];}
                    ?>
                    <div class="col-6">
