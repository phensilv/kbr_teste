            ...
            <div class="bg-custom rounded overflow-hidden">
                <table class="table mb-0 table-custom table-dark align-middle">
                    ...
                    <tbody>
                        ...
                        $comando = "SELECT * FROM usuarios ORDER BY id DESC";
                        ...
                        while($user_data = mysqli_fetch_assoc($result)){
                            ...
                            echo "<td>
                                    <div class='d-flex justify-content-center'>
                                        ...
                                        <a href='editar.php?id=$user_data[id]' class='btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2' title='Editar'>
